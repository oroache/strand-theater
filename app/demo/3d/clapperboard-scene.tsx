...
// Split into its own module (rather than inlined in page.tsx) so
// `next/dynamic({ ssr: false })` can defer pulling three.js/@react-three
// into the client bundle until this component actually mounts.
export default function ClapperboardScene({ open }: { open: boolean }) {
  return (
